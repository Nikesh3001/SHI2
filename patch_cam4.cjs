...
const oldLogic = `            // Force authorization for demo to make the team detectable (green)
...
const newLogic = `            // Force authorization for demo to make the team detectable (green), UNLESS simulating intruder
...
console.log("Patched CameraStream.tsx for anomaly detection.");
