...
import { RecognitionResult } from './faceRecognitionEngine';
...
export interface SimulatedTarget {
  ...
  cocoId?: number;
  isHuman?: boolean;
  // Biometric / Facial Recognition Attributes
...
export function createInitialCameraTargets(camera: Camera): SimulatedTarget[] {
  ...
  switch (code) {
      ...
      return [
        {
          ...
          trackId: 101,
          type: 'person',
          label: '[AUTH] SEC-LBRCE-01 NIKESH REDDY 98.4%',
          confidence: 0.984,
          isHuman: true,
          isAuthorizedTeamMember: true,
          isFaceRecognized: true,
          isUnknownSubject: false,
          memberId: 'SEC-LBRCE-01',
          memberName: 'Nikesh Reddy',
      ...
      return [
        {
          ...
          trackId: 102,
          type: 'person',
          label: 'UNREGISTERED FACE [NEW SUBJECT] 97.4%',
          confidence: 0.974,
          isHuman: true,
          isAuthorizedTeamMember: false,
        ...
        },
        {
          ...
          trackId: 1022,
          type: 'person',
          label: '[AUTH] SEC-LBRCE-02 K. SRAVANI 99.1%',
          confidence: 0.991,
          isHuman: true,
          isAuthorizedTeamMember: true,
          isFaceRecognized: true,
          isUnknownSubject: false,
          memberId: 'SEC-LBRCE-02',
          memberName: 'K. Sravani',
          matchConfidence: 0.991,
          x: 78,
          y: 58,
          w: 5.0,
          h: 12,
      ...
      return [
        {
          ...
          trackId: 602,
          type: 'person',
          label: '⚠ [RED OBJECT] ANOMALY: RIVERINE INFILTRATOR 95.8%',
          confidence: 0.958,
          isHuman: true,
          isAuthorizedTeamMember: false,
          isFaceRecognized: false,
        ...
        },
        {
          ...
          trackId: 603,
          type: 'person',
          label: '[AUTH] SEC-LBRCE-05 M. SAI 98.7%',
          confidence: 0.987,
          isHuman: true,
          isAuthorizedTeamMember: true,
          isFaceRecognized: true,
          isUnknownSubject: false,
          memberId: 'SEC-LBRCE-05',
          memberName: 'M. Sai',
          matchConfidence: 0.987,
          x: 22,
          y: 44,
          w: 4.8,
          h: 11,
          ...
          speedKmh: 4.1,
          heading: 90,
          behavior: 'Riverine Shore Sentry',
          color: '#10b981',
          trail: [],
          animCycle: 0,
          waypoints: [
          ...
          breachTimer: 0,
          dwellSeconds: 15,
          thermalIntensity: 0.82
        }
      ];

    case 'CAM-06': // Dense Foliage / Ambush Sector
      return [
        {
          id: `${camera.id}-tgt-1`,
          trackId: 701,
          type: 'person',
          label: '⚠ [RED OBJECT] ANOMALY: CAMOUFLAGE CRAWLER 96.7%',
          confidence: 0.967,
          isHuman: true,
          isAuthorizedTeamMember: false,
          isFaceRecognized: false,
          ...
          breachTimer: 80,
          dwellSeconds: 40,
          thermalIntensity: 0.91
        },
        {
          id: `${camera.id}-tgt-2`,
          trackId: 702,
          type: 'person',
          label: '[AUTH] SEC-LBRCE-03 P. VAMSHI 99.1%',
          confidence: 0.991,
          isHuman: true,
          isAuthorizedTeamMember: true,
          isFaceRecognized: true,
          isUnknownSubject: false,
          memberId: 'SEC-LBRCE-03',
          memberName: 'P. Vamshi',
          matchConfidence: 0.991,
          x: 25,
          y: 50,
          ...
          speedKmh: 4.5,
          heading: 90,
          behavior: 'Foliage Outpost Patrol',
          color: '#10b981',
          trail: [],
          animCycle: 0,
          waypoints: [
      ...
      return [
        {
          ...
          trackId: 801,
          type: 'person',
          label: '⚠ [RED OBJECT] ANOMALY: ZERO-LINE INTRUDER 99.2%',
          confidence: 0.992,
          isHuman: true,
          isAuthorizedTeamMember: false,
          isFaceRecognized: false,
    ...
    case 'CAM-08': // Pipeline Outpost Sentry
      return [
        {
          id: `${camera.id}-tgt-1`,
          trackId: 851,
          type: 'person',
          label: '⚠ [RED OBJECT] ANOMALY: PIPELINE TRESPASSER 97.4%',
          confidence: 0.974,
          isHuman: true,
          isAuthorizedTeamMember: false,
          isFaceRecognized: false,
          ...
          breachTimer: 65,
          dwellSeconds: 28,
          thermalIntensity: 0.89
        },
        {
          id: `${camera.id}-tgt-2`,
          trackId: 852,
          type: 'person',
          label: '[AUTH] SEC-LBRCE-04 G. TEJA 98.9%',
          confidence: 0.989,
          isHuman: true,
          isAuthorizedTeamMember: true,
          isFaceRecognized: true,
          isUnknownSubject: false,
          memberId: 'SEC-LBRCE-04',
          memberName: 'G. Teja',
          matchConfidence: 0.989,
          x: 28,
          y: 48,
          w: 5,
          h: 12,
          ...
          speedKmh: 4.0,
          heading: 270,
          behavior: 'Pipeline Sector Sentry',
          color: '#10b981',
          trail: [],
          animCycle: 0,
          waypoints: [
    ...
    default:
      // Generic tactical camera: Any unverified person MUST be an ANOMALY in RED
      return [
        {
          id: `${camera.id}-tgt-gen`,
          trackId: 201,
          type: 'person',
          label: '⚠ [RED OBJECT] ANOMALY PERSON: UNREGISTERED 96.1%',
          confidence: 0.961,
          isHuman: true,
          isAuthorizedTeamMember: false,
          isFaceRecognized: false,
